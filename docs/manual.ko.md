...
- [05. Phase 0 → 11 — 실제로 있었던 일](#05-phase-0--11--실제로-있었던-일)
...
# ──────── 검증 ────────
cd backend; .\.venv\Scripts\python.exe -m pytest -q     # 191개
