...
- [05. Phase 0 → 9 — 실제로 있었던 일](#05-phase-0--9--실제로-있었던-일)
...
| **제작** | Phase 1부터 9까지, 각 단계마다 통과 조건(gate)을 걸고 순서대로 | 테스트 195개가 통과하는, 브라우저에서 도는 프로그램 |
...
# ──────── 검증 ────────
cd backend; .\.venv\Scripts\python.exe -m pytest -q     # 171개
